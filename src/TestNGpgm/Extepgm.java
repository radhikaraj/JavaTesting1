...
public class Extepgm {
	...
	ExtentReports extent;
		...
		public void beftest()
		{
			//reporter=new ExtentHtmlReporter(System.getProperty("user.dir")+"/reports/myreport.html"); used in selenium version3
		...
		{
			//actions class we use perform instead flush used in extent
			extent.flush();
		}
	...
	//static method can call without object and call using class name
